    ...
    <section className="mx-auto text-gray-600 bg-gradient-to-l from-black to-blue-900 max-w-screen body-font lg:my-16">
      <div className="container flex flex-col items-center px-5 py-32 mx-auto md:flex-row">
        <div className="flex flex-col w-full pr-0 mb-6 text-center md:pr-10 md:mb-0 md:w-auto md:text-left">
          ...
          <h3 className="text-3xl font-semibold text-blue-50 md:text-3xl title-font">
            KinnectFit Fitness
          </h3>
        </div>
        <div className="flex items-center flex-shrink-0 mx-auto space-x-4 md:ml-auto md:mr-0">
          <button className="inline-flex items-center px-5 py-3 bg-white rounded-lg hover:bg-gray-200 focus:outline-none">
            <svg
            ...
            <span className="flex flex-col items-start ml-4 leading-none">
              <span className="mb-1 text-xs text-gray-700">GET IT ON</span>
