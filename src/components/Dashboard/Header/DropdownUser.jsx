    ...
    <div className="relative z-50">
      ...
      >
        ...
        <span className="h-12 w-12 rounded-full">
          <Image width={112} height={112} src={demoUser} alt="User" />
        </span>
      ...
      >
        <ul className="flex flex-col gap-5 border-b border-stroke px-6 py-4 hover:bg-indigo-100">
          <li>
            <Link
              href="/"
              className="flex items-center gap-3.5 text-sm font-medium duration-300 ease-in-out  text-blue-800  lg:text-base"
            >
              <HomeIcon
